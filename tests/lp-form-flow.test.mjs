...
const heroVideoPath = new URL("../assets/seedmypeople-v5.mp4", import.meta.url);
const heroPosterPath = new URL("../assets/seedmypeople-v5-poster.jpg", import.meta.url);
...
test("index.html uses the local VSL video in the hero", () => {
  ...
  assert.match(html, /<video class="hero-video-player" controls playsinline preload="metadata" poster="assets\/seedmypeople-v5-poster\.jpg">/);
  assert.match(html, /<source src="assets\/seedmypeople-v5\.mp4" type="video\/mp4">/);
